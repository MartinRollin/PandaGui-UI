...
var panda_data_listener = new ROSLIB.Topic({
  ros: ros,
  name: "/torque_qp/panda_rundata",
  messageType: "torque_qp/PandaRunMsg",
  queue_size: 1,
  throttle_rate: 1000,
});
...
function watchdog() {
  if (joint_state_stamp == old_joint_state_stamp) {
    ...
    document.getElementById("connection_state_div").style.backgroundColor =
      "bisque";
...
function Activate_Button(button_id, state) {
  if (state == 1) document.getElementById(button_id).style.background = "red";
  if (state == 0)
...
function ToEulerAngles(qw, qx, qy, qz) {
  ...
  if (Math.abs(sinp) >= 1) pitch = copysign(3.14159 / 2, sinp);
...
robot_state_listener.subscribe(function (message) {
  document.getElementById("pos_x").innerHTML = message.pose.position.x.toFixed(
    3
  );
  document.getElementById("pos_y").innerHTML = message.pose.position.y.toFixed(
    3
  );
  document.getElementById("pos_z").innerHTML = message.pose.position.z.toFixed(
    3
  );
...
var updateUIClient = new ROSLIB.Service({
  ros: ros,
  name: "/torque_qp/updateUI",
  serviceType: "torque_qp/UI",
});
...
function fakeDistance() {
  ...
  if (!fake_distance_) {
    ...
    fake_distance_ = !fake_distance_;
    document.getElementById("fake_distance_button_").style.background =
      "rgb(255, 255, 255)";
  }
  updateUIClient.callService(new_request, function (result) {});
  request = new_request;
...
function distToContact() {
  var new_request = request;
  var distance_to_contact_ = document.getElementById(
    "distance_to_contact_slider"
  ).value;
  new_request.distance_to_contact_ = parseFloat(distance_to_contact_);
  updateUIClient.callService(new_request, function (result) {});
  request = new_request;
  document.getElementById(
    "distance_to_contact_value"
  ).value = distance_to_contact_;
}
...
var getTauLim = new ROSLIB.Param({
  ros: ros,
  name: "/torque_qp/qd_max_",
});

getTauLim.get(function (value) {
  document.getElementById("qp0_slider_min_value").value = -value[0];
  document.getElementById("qp0_slider").min = -value[0];
  document.getElementById("qp1_slider_min_value").value = -value[1];
  document.getElementById("qp1_slider").min = -value[1];
  document.getElementById("qp2_slider_min_value").value = -value[2];
  document.getElementById("qp2_slider").min = -value[2];
  document.getElementById("qp3_slider_min_value").value = -value[3];
  document.getElementById("qp3_slider").min = -value[3];
  document.getElementById("qp4_slider_min_value").value = -value[4];
  document.getElementById("qp4_slider").min = -value[4];
  document.getElementById("qp5_slider_min_value").value = -value[5];
  document.getElementById("qp5_slider").min = -value[5];
  document.getElementById("qp6_slider_min_value").value = -value[6];
  document.getElementById("qp6_slider").min = -value[6];

  document.getElementById("qp0_slider_max_value").value = value[0];
  document.getElementById("qp0_slider").max = value[0];
  document.getElementById("qp1_slider_max_value").value = value[1];
  document.getElementById("qp1_slider").max = value[1];
  document.getElementById("qp2_slider_max_value").value = value[2];
  document.getElementById("qp2_slider").max = value[2];
  document.getElementById("qp3_slider_max_value").value = value[3];
  document.getElementById("qp3_slider").max = value[3];
  document.getElementById("qp4_slider_max_value").value = value[4];
  document.getElementById("qp4_slider").max = value[4];
  document.getElementById("qp5_slider_max_value").value = value[5];
  document.getElementById("qp5_slider").max = value[5];
  document.getElementById("qp6_slider_max_value").value = value[6];
  document.getElementById("qp6_slider").max = value[6];
});

var getqdmin = new ROSLIB.Param({
  ros: ros,
  name: "/torque_qp/qd_min_",
});

getqdmin.get(function (value) {
  document.getElementById("qd0_slider_min_value").value = value[0];
  document.getElementById("qd0_slider").min = value[0];
  document.getElementById("qd1_slider_min_value").value = value[1];
  document.getElementById("qd1_slider").min = value[1];
  document.getElementById("qd2_slider_min_value").value = value[2];
  document.getElementById("qd2_slider").min = value[2];
  document.getElementById("qd3_slider_min_value").value = value[3];
  document.getElementById("qd3_slider").min = value[3];
  document.getElementById("qd4_slider_min_value").value = value[4];
  document.getElementById("qd4_slider").min = value[4];
  document.getElementById("qd5_slider_min_value").value = value[5];
  document.getElementById("qd5_slider").min = value[5];
  document.getElementById("qd6_slider_min_value").value = value[6];
...
getqdmax.get(function (value) {
  document.getElementById("qd0_slider_max_value").value = value[0];
  document.getElementById("qd0_slider").max = value[0];
  document.getElementById("qd1_slider_max_value").value = value[1];
  document.getElementById("qd1_slider").max = value[1];
  document.getElementById("qd2_slider_max_value").value = value[2];
  document.getElementById("qd2_slider").max = value[2];
  document.getElementById("qd3_slider_max_value").value = value[3];
  document.getElementById("qd3_slider").max = value[3];
  document.getElementById("qd4_slider_max_value").value = value[4];
  document.getElementById("qd4_slider").max = value[4];
  document.getElementById("qd5_slider_max_value").value = value[5];
  document.getElementById("qd5_slider").max = value[5];
  document.getElementById("qd6_slider_max_value").value = value[6];
