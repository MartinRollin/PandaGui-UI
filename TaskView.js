...
TaskView.prototype = {
  ...
  createChildren: function() {
    ...
    this.$partsContainer = this.$container.find(".js-parts-container");
  ...
  buildList: function() {
    ...
    var html = "";
    var $partsContainer = this.$partsContainer;
    ...
    for (var task in tasks) {
      ...
      $partsContainer.append(
        html +
          '<div id="' +
          tasks[task].taskName +
          'Div" class="jointState movingDiv">' +
          '<div class="toggleBar">' +
          '<div id="' +
          tasks[task].taskName +
          'Header" class="Header">' +
      ...
      let divName = tasks[task].taskName + "Div";
